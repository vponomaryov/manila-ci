...
sed -i "s#PIP_GET_PIP_URL=https://bootstrap.pypa.io/get-pip.py#PIP_GET_PIP_URL=https://dl.openstack.tld/get-pip.py#g" /home/ubuntu/devstack/tools/install_pip.sh
